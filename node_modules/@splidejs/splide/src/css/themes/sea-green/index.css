...
.splide__arrow:hover:not(:disabled) svg {
  fill: rgb(87.1714285714, 224.8285714286, 217.2857142857);
}
.splide__arrow:disabled {
  opacity: 0.3;
}
.splide__arrow:focus-visible {
  outline: #20b2aa 3px solid;
  outline-offset: 3px;
}
.splide__arrow--prev {
  left: 1em;
...
.splide__pagination__page:hover {
  cursor: pointer;
  opacity: 0.9;
  background: rgb(87.1714285714, 224.8285714286, 217.2857142857);
}
